        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RecipeCollectionId = table.Column<Guid>(type: "TEXT", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RecipeInCollections", x => x.Id);
                    table.ForeignKey(
                        name: "FK_RecipeInCollections_RecipeCollections_CollectionId",
                        column: x => x.CollectionId,
                        principalTable: "RecipeCollections",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_RecipeInCollections_Recipes_RecipeId",
                        column: x => x.RecipeId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RecipeInCollections_CollectionId",
                table: "RecipeInCollections",
                column: "CollectionId");

            migrationBuilder.CreateIndex(
                name: "IX_RecipeInCollections_RecipeId",
                table: "RecipeInCollections",
                column: "RecipeId");
